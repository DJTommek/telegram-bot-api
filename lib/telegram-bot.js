...
var TelegramApi = function (params)
{
    ...
    this.sendMessage = function (params, cb)
    {
        ...
        if (params.allow_sending_without_reply !== undefined) args.allow_sending_without_reply = params.allow_sending_without_reply;
     ...
     */
    this.approveChatJoinRequest = function (params, cb)
    {
        return new Promise(function(resolve, reject)
        {
            _rest({
                ...
                json: true,
                formData: params,
                uri: _baseurl + 'approveChatJoinRequest'
            })
            .then(function(body)
            {
                return commonResponseHandler(body);
     ...
     */
    this.declineChatJoinRequest = function (params, cb)
    {
        return new Promise(function(resolve, reject)
        {
            _rest({
                ...
                json: true,
                formData: params,
                uri: _baseurl + 'declineChatJoinRequest'
            })
            .then(function(body)
            {
                return commonResponseHandler(body);
